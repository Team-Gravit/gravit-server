...
public interface FriendRepository {
    ...
    Slice<FollowerResponse> findFollowersByFolloweeId(long followeeId, Pageable pageable);

    Slice<FollowingResponse> findFollowingsByFollowerId(long followerId, Pageable pageable);
}
