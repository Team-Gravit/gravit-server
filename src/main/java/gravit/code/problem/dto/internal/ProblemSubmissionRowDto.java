...
public record ProblemSubmissionRowDto(
    ...
    public static ProblemSubmissionRowDto from(ProblemSubmissionSaveRequest request) {
        return new ProblemSubmissionRowDto(
                request.problemId(),
                request.isCorrect(),
