...
public class SecurityConfig {
    ...
    public CorsConfigurationSource configurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://grav-it.inuappcenter.kr", "http://localhost:5173", "https://gravit.inuappcenter.kr", "https://gravit-cs.vercel.app", "https://gravit-dev.inuappcenter.kr"));  // 특정 도메인 허용
