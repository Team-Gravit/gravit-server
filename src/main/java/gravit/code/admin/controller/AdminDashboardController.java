...
public class AdminDashboardController implements AdminDashboardControllerDocs {
    ...
    public ResponseEntity<DashboardSummaryResponse> getSummary() {
        return ResponseEntity.status(OK).body(adminDashboardService.getSummary());
    }
    ...
    public ResponseEntity<DailyActiveUserTrendResponse> getDailyActiveUsers(
        ...
        return ResponseEntity.status(OK).body(adminDashboardService.getDailyActiveUsers(days));
    }
    ...
    public ResponseEntity<MonthlyActiveUserTrendResponse> getMonthlyActiveUsers(
        ...
        return ResponseEntity.status(OK).body(adminDashboardService.getMonthlyActiveUsers(months));
    }
}
