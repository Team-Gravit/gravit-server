// PERF-472 / weak-concepts 부하 테스트 스크립트.
//
...
//     -e SUMMARY_OUT=$TARGET_DIR/k6-test-summary-{n}.json $TARGET_DIR/test-script.js
...
const TARGET = 'weak-concepts';
const ENDPOINT = 'GET /api/v1/my-pages/learning/weak-concepts';
const CONDITION = {
    vus: 50,
...
export default function () {
    ...
    const res = http.get(`${BASE_URL}/api/v1/my-pages/learning/weak-concepts`, params);
    ...
    check(res, {
        ...
        '취약 유닛이 실려 있다': (r) => {
            ...
            return body !== null && Array.isArray(body) && body.length > 0 && body[0].unitId !== undefined;
        },
    });
}
