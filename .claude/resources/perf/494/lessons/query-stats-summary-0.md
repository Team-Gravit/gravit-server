...
비고: 로컬 DB에 V3 인덱스 3개가 없는 상태에서 잰 1차 측정은 폐기하고, 인덱스를 복구한 뒤 다시 잰 값이다. 코드는 바뀌지 않았으므로 상태 번호는 0을 유지한다
...
| 9 | 1.00007664479735115580 | 65241 | 0.0009213586088502636 | 60.110356999996476 | 0.08115674788294361% | - | 트랜잭션 제어 |
...
| 11 | 0.00068980317616040223 | 45 | 0.0006250888888888889 | 0.028129000000000015 | 3.797778411463196e-05% | - | 트랜잭션 제어 |
| 12 | 0.000045986878410693482126 | 3 | 0.001097 | 0.003291 | 4.443275179396839e-06% | - | 트랜잭션 제어 |
